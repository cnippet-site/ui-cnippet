...
const components = {
    ...
    Step: ({ className, ...props }: React.ComponentProps<"h3">) => (
        <h3
            className={cn(
                "font-sans step font-bold [&>p]:font-medium text-base text-black dark:text-white",
                className,
            )}
            {...props}
        />
    ...
    Steps: ({ ...props }) => (
        <div
            className="steps mb-16 ml-4 border-l border-neutral-100 pl-[2.1rem] [counter-reset:step] dark:border-neutral-500"
            {...props}
        />
    ),
